package engine.screens{
	...
	public function fadeOut() {
	    fadeOutCounter++;
	    if(fadeOutCounter > 0 && fadeLevel == 0) {
		fadeLevel = 1;
		var fadeout1 = new Bitmap(new titlefade_1(0, 0));
		addChild(fadeout1);
	    } else if(fadeOutCounter > 15 && fadeLevel == 1) {
		fadeLevel = 2;
		var fadeout2 = new Bitmap(new titlefade_2(0, 0));
		addChild(fadeout2);
	    } else if(fadeOutCounter > 30) {
